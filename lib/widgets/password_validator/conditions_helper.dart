...
class ConditionsHelper {
  ...
  void setSelectedCondition(int minLength, normalCharCount, uppercaseCharCount, numericCharCount, specialCharCount) {
    _selectedCondition = {
  ...
  dynamic checkCondition(int userRequestedValue, Function validator, TextEditingController controller, String key, dynamic oldValue) {
    dynamic newValue;
